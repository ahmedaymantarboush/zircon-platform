...
document.querySelector('table').addEventListener('click', function (e) {
    ...
    let lectureId = e.target.closest('tr').dataset.lectureid
    let userId = e.target.closest('tr').dataset.userid
    let lectureName = e.target.closest('tr').querySelector('.name-lesson').innerText.trim();

    document.querySelectorAll('.del-lesson').forEach(e=>{
        e.innerHTML=lectureName;
    })
    document.querySelectorAll('.lectureId').forEach(e=>{
        e.value = lectureId
    })
