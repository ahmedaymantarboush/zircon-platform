        ...
        <table class="">
            ...
            <tbody>
                ...
                {{-- <tr class="">
                    ...
                    <td data-lable="الأسم :" class="address">
                        <button type="button" class="btn name-lesson question-code" data-toggle="tooltip"
                            data-placement="top" title="سنتر علي علاء لدراسة مادة التاريخ وايضا مادة التاريخ">
                ...
                <form action="">
                    <div class="modal-body">
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="input-parent">
                                <input type="text" class="my-input is-invalid" placeholder=" ادخل لينك المكان"
                                    id="address-lec" />
                                @error('error')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                ...
                <form action="{{route('admin.centers.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="less-item custome-item">
                            ...
                            <div class="input-parent">
                                <input type="text" name='name' value="{{old('name')}}" class="my-input @error('name') is-invalid @enderror"
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="input-parent">
                                <input type="text" name='url' value="{{old('url')}}" class="my-input @error('url') is-invalid @enderror"
                            ...
                            <div class="search-select modify-select">
                                <select name='governorate' id="" class="@error('governorate') is-invalid @enderror"
                                    ...
                                    @foreach (\App\Models\Governorate::all() as $governorate)
                                        <option @selected(old('governorate') == $governorate->id) value="{{$governorate->id}}">{{$governorate->name}}</option>
                                    @endforeach
                                </select>
                                @error('governorate')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        {{-- <div class="less-item">
                            <label class="sec-name">وصف الدرس</label>
                            <textarea class="text-editor1 @error('error') is-invalid @enderror"></textarea>
                            @error('error')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <form action="{{route('admin.centers.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="less-item custome-item">
                            ...
                            <div class="input-parent">
                                <input type="text" name='newName' value="{{old('newName')}}" class="my-input @error('newName') is-invalid @enderror"
                                    placeholder=" ادخل اسم المكان" id="address-lec" />
                                @error('newName')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="input-parent">
                                <input type="text" name='newUrl' value="{{old('newUrl')}}" class="my-input @error('newUrl') is-invalid @enderror"
                                    placeholder=" ادخل لينك المكان" id="address-lec" />
                                @error('newUrl')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="search-select modify-select">
                                <select name='newGovernorate' id="" class="@error('newGovernorate') is-invalid @enderror"
                                    ...
                                    <option value="">اختر المحافظة</option>
                                    @foreach (\App\Models\Governorate::all() as $governorate)
                                        <option @selected(old('newGovernorate') == $governorate->id) value="{{$governorate->id}}">{{$governorate->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="file">
                            <label for="">رفع صورة المكان</label>
                            <input type="file" name='newImage' class="form-control @error('newImage') is-invalid @enderror" />
                            @error('newImage')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
