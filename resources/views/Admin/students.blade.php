        ...
        <td class="features" data-lable="اجراءات :">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu feat-menu">
                    ...
                    <li>
                        <a data-bs-toggle="modal" data-bs-target="#studentCard" class="dropdown-item studentCard"
                            href="#">كارت
                            الطالب
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item handStudent" href="#">{{ $user->hanging ? 'الغاء' : '' }} تعليق
                            الطالب</a>
                    </li>
                    <li>
                        <a data-bs-toggle="modal" data-bs-target="#editCharge" class="dropdown-item editCharge"
                            href="#">تعديل
                            رصيد
                            الطالب</a>
                    </li>
                    <li>
                        <a data-bs-toggle="modal" data-bs-target="#editCode" class="dropdown-item editCode"
                            href="#">تعديل كود
                            الطالب</a>
                    </li>
                    <li>
    ...
    <div class="modal fade" id="editCharge" tabindex="-1" aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="" id="saveBalanceForm">
                    <div class="modal-body">
