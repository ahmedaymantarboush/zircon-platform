...
@section('content')
        ...
        <div class="col-lg-3 col-sm-6">
            <a class="real-stc" style="width: 100%">
                <div class="stc-box second-stc">
                    <div class="stc-val-parent">
                        <span class="stc-value">
                            {{ number_format(count(\App\Models\AnswerdQuestion::where('correct', 0)->get()), 2) }}
                        </span>
        ...
        <div class="col-lg-3 col-sm-6">
            <a class="real-stc" style="width: 100%">
                <div class="stc-box second-stc">
                    <div class="stc-val-parent">
                        <span class="stc-value">
                            {{ \App\Models\Exam::where('user_id', Auth::user()->id)->count()  }}
                        </span>
    ...
    <form action="{{request()->url()}}" class="lec-filter">
