            ...
            <tr data-id="{{ $testimonial }}">
                ...
                <td data-lable="الاسم :" class="address">
                    <div class="custome-parent">
                        <button type="button" class="btn name-lesson" data-toggle="tooltip" data-placement="top"
...
<div class="modal fade" id="addCertificateModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
                    ...
                    <div class="less-item custome-item">
                        ...
                        <div class="input-parent">
                            <input type="text" name="degree" value="{{ old('degree') }}"
                                class="my-input @error('degree') is-invalid @enderror" placeholder=" ادخل مجموع الطالب"
                                id="address-lec" />
                            @error('degree')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
        ...
        <div class="less-item custome-item">
            ...
            <div class="input-parent">
                <input type="text" name="subjectDegree" value="{{ old('subjectDegree') }}"
                    class="my-input @error('subjectDegree') is-invalid @enderror" placeholder=" مجموع الطالي في المادة"
                    id="address-lec" />
                @error('subjectDegree')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
        ...
        <div class="less-item custome-item">
            ...
            <div class="search-select modify-select">
                <select name="grade" id="" class="@error('grade') is-invalid @enderror" data-live-search="true">
                    <option value="">
    ...
    <div class="modal-dialog">
        ...
        <div class="less-item">
            ...
            <textarea name="newContent"
                class="text-editor2 @error('newContent') is-invalid @enderror">{{ old('newContent') }}</textarea>
            @error('newContent')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
...
<div class="less-item custome-item">
    ...
    <div class="input-parent">
        <input type="text" class="my-input editStudentSum is-invalid" placeholder=" ادخل مجموع الطالب"
            id="address-lec" />
        @error('error')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
...
<div class="less-item custome-item">
    ...
    <div class="input-parent">
        <input type="text" class="my-input subjectSum is-invalid" placeholder=" مجموع الطالي في المادة"
            id="address-lec" />
        @error('error')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
