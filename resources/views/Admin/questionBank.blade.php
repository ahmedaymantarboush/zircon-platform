...
<form action="" class='editModalForm'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="search-select modify-select" id="select-subject-parent">
                                <select name="newSubject" id="" class="@error('newSubject') is-invalid @enderror"
                                    data-live-search="true">
                                    <option value="">
                                        اختر المادة
                                    </option>
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="search-select modify-select" id="chooseHard">
                                <select name="newLevel" id="" class="@error('newLevel') is-invalid @enderror"
                                    data-live-search="true">
                                    <option value="">
                                        اختر درجة الصعوبة
                                    </option>
                                    @for ($i = 1; $i <= 4; $i++) <option @selected(old('newLevel')==$i)
                                        value="{{ $i }}">
                                        {{ $i }}
                                        </option>
                                        @endfor
    ...
    <div class="modal fade" id="nextPopupQuick" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title addQuestionTitle" id="exampleModalLabel">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="file" id="hasImageFile">
                            ...
                            <input name="newImage" value="{{ old('newImage') }}"
                                class="form-control @error('newImage') is-invalid @enderror" type="file" id="formFile"
                                value="تصفح" accept="image/png, image/jpeg" />
                            @error('newImage')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="less-item">
                            ...
                            <textarea id='descriptionQues' name="newText"
                                class="text-editor2">{{old('newText')}}</textarea>
                        </div>
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="search-select modify-select" id="select-part-parent">
                                <select name="level" id="" class="@error('level') is-invalid @enderror"
                                    ...
                                    @for ($i = 1; $i <= 4; $i++) <option @selected(old('level')==$i) value="{{ $i }}">
                                        {{ $i }}
                                        </option>
                                        @endfor
                ...
                <div>
                    <div class="modal-body">
                        <div>
                            <label for="" class="sec-name">هل هذا السؤال يحتوي على صورة ؟</label>
                            <div class="hasImage">
                                <input name="hasImage" @checked(old('hasImage')) type="checkbox" id="hasImageCheck" />
                                <label for="">ضع علامة اذا كان السؤال يحتوي على
                                    صورة</label>
                            </div>
                        </div>
