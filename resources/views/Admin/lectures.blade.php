                                    ...
                                    <ul class="dropdown-menu feat-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('months.show', $lecture->slug) }}">عرض
                                                صفحة المحاضرة</a>
                                        </li>
                                        <li>
                                            <form action="{{ route('lectures.view') }}" method="post">
                                                ...
                                                <button class="dropdown-item" type="submit">عرض صفحة تشغيل
                                                    المحاضرة</button>
                                            </form>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="dropdown-item "
                                                href="{{ route('lectures.edit', $lecture->slug) }}">تعديل
                                                المحاضرة</a>
                                        </li>
                                        {{-- <li>
                                        ...
                                        <li>
                                            <form action="{{ route('admin.lectures.hanging') }}" method="post">
                                                ...
                                                <button class="dropdown-item"
                                                    type="submit">{{ $lecture->published ? 'تعليق' : 'نشر' }}
                                                    المحاضرة</button>
                                            </form>
                                        </li>
                                        <li>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.lectures.fastEdit') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name='slug' class='slugInput'>
                            ...
                            <div class="search-select multiSelectParent modify-select">
                                <select name="parts[]" multiple="multiple" id=""
                                    ...
                                    @foreach ($parts as $part)
                                        <option @selected(old('parts') ? in_array($part->id, old('parts')) : false) value="{{ $part->id }}">
                                            {{ $part->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="less-item custome-item">
                            ...
                            <div class="search-select modify-select">
                                <input name="finalPrice" value="{{ old('finalPrice') }}" id="" type="number"
                                    min="0" class="my-input editPrice @error('finalPrice') is-invalid @enderror"
                                    data-live-search="true">
                                @error('finalPrice')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
