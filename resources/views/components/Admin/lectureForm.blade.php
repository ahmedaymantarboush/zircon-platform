                ...
                <div class="search-select-box">
                    <select name="parts[]" multiple="multiple" data-live-search="true"
                        ...
                        @foreach (\App\Models\Part::all() as $part)
                            <option
                            @selected((isset($lecture)) && in_array($part->id, $lecture->parts->pluck('id')->toArray() ?? []) || in_array($part->id,old('parts') ?? []))
                                value="{{ $part->id }}">
                                {{ $part->name }}
                            </option>
                        @endforeach
            ...
            <div class="pricing-content">
                ...
                <div class="dis-parent">
                    <div class="pricing-item" style="flex-wrap: wrap">
                        ...
                        <p class="dis">
                            مقدار الخصم
                            <span class="price-discount">@if(isset($lecture) && $lecture->price){{number_format($lecture->price ? ($lecture->price - $lecture->final_price) * 100 / ($lecture->price) : 0)}} @else 0 @endif</span>
                        </p>
                    </div>
                    <div class="dis-date">
