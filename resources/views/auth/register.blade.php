...
<div class="content">
    ...
    <form action="{{route('register')}}" method="post">
        ...
        <div class="box  @error('parent_phone_number') isInvalid @enderror">
            <div class="inputItem">
                <span class='inputIcon'><i class="fa-solid fa-phone-flip"></i></span>
                <input type="text" name='parent_phone_number' value="{{old('parent_phone_number')}}" placeholder='&nbsp;'>
            ...
            <div class="inputItem ">
                ...
                <select name="governorate" id="">
                    ...
                    @foreach (\App\Models\Governorate::all() as $governorate)
                        <option @selected(old('governorate') == $governorate->name) value="{{$governorate->name}}">{{$governorate->name}}</option>
                    @endforeach
                </select>
            </div>
            @error('governorate')
