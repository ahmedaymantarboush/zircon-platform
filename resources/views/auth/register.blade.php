        ...
        <div class="box @error('governorate') isInvalid @enderror">
            <div class="inputItem ">
                ...
                <select name="governorate" id="">
                    ...
                    <option @selected(old('governorate')==$governorate->name)
                        value="{{ $governorate->name }}">{{ $governorate->name }}
                    </option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="box @error('center') isInvalid @enderror">
            <div class="inputItem ">
                ...
                <select name="center" id="">
                    ...
                    <option @selected(old('center')==$center->name) value="{{ $center->name }}">{{ $center->name }}
                    </option>
                    @endforeach
                </select>
            </div>
