                        ...
                        <div class="card-body">
                            <ul class="filter-items">
                                ...
                                <li class="filter-item">
                                    ...
                                    $id = $grade->id + 9;
                                    @endphp
                                    <input type="checkbox" value="{{ $grade->id }}" @checked(array_key_exists('grades',
                                        $appliedFilters) ? (count($appliedFilters) ? in_array($grade->id,
                                    $appliedFilters['grades'])
                                    : false)
                                    : false) name="grade{{ $id }}" />
                                    <label for="">
                                        {{ $grade->name }}
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo">
                        <div class="card-body">
                            <ul class="filter-items">
                                ...
                                <li class="filter-item">
                                    <input type="checkbox" @checked(count($appliedFilters) ? (array_key_exists('price',
                                        $appliedFilters) ? in_array('free', $appliedFilters['price']) : false) : false)
                                        name="free" />
                                    <label for="">
                                        مجاني
                                        @php
                                ...
                                <li class="filter-item">
                                    <input type="checkbox" @checked(count($appliedFilters) ? (array_key_exists('price',
                                        $appliedFilters) ? in_array('hasDiscount', $appliedFilters['price']) : false) :
                                ...
                                <li class="filter-item">
                                    <input type="checkbox" @checked(count($appliedFilters) ? (array_key_exists('price',
                                        $appliedFilters) ? in_array('paid', $appliedFilters['price']) : false) : false)
                                        name="paid" />
                                    <label for="">
                                        مدفوع
                                        @php
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree">
                        <div class="card-body">
                            <ul class="filter-items">
                                ...
                                <li class="filter-item">
                                    <input type="checkbox" value="{{ $part->id }}" @checked(array_key_exists('parts',
                                        $appliedFilters) ? (count($appliedFilters) ? in_array($part->id,
                                    $appliedFilters['parts'])
                                    : false)
